 ...
 * @public
 */
Configuration.prototype.getNestedConfiguration = function(propPath) {
    ...
    } else if ( ! (_conf instanceof Configuration)) {
        return ou.set(this._data, propPath, new Configuration(_conf, this._resolveBaseDir));
    }
};
